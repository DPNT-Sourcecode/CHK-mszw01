...
class TestCheckout(unittest.TestCase):
    ...
    def test_empty_and_single_skus(self):
        ...
        self.assertEqual(checkout('C'), 50)
        self.assertEqual(checkout('D'), 50)
        self.assertEqual(checkout('E'), 50)
        self.assertEqual(checkout('F'), 10)
        self.assertEqual(checkout('FF'), 20)
        self.assertEqual(checkout('G'), 50)
        self.assertEqual(checkout('H'), 50)
        self.assertEqual(checkout('I'), 50)
        self.assertEqual(checkout('J'), 50)
        self.assertEqual(checkout('K'), 50)
        self.assertEqual(checkout('L'), 50)
        self.assertEqual(checkout('M'), 50)
        self.assertEqual(checkout('N'), 50)
        self.assertEqual(checkout('O'), 50)
        self.assertEqual(checkout('P'), 50)
        self.assertEqual(checkout('Q'), 50)
        self.assertEqual(checkout('R'), 50)
        self.assertEqual(checkout('S'), 50)
        self.assertEqual(checkout('T'), 50)
        self.assertEqual(checkout('U'), 50)
        self.assertEqual(checkout('V'), 50)
        self.assertEqual(checkout('W'), 50)
        self.assertEqual(checkout('X'), 50)
        self.assertEqual(checkout('A'), 50)
        self.assertEqual(checkout('A'), 50)
